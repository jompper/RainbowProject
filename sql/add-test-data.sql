...
INSERT INTO users (role_id, username, password, full_name, email) VALUES (1, 'admin', '', 'Puuha Pete'), (2, 'basic', '', 'T. Tavallinen', 'tero@tavallinen.fi');
...
INSERT INTO projects (customer_id, priority_id, status_id, name, description) VALUES (1, 1, 1, 'Tuntiseuranta', 'Toteutetaan asiakkaalle tuntiseuranta- / projektinhallintajärjestelmä');
